...
Dashboard de Positividade Toxicológica - Synvia
...
def create_login_page(auth: MicrosoftAuth) -> bool:
    ...
    if logo_base64:
        ...
        logo_html = '<div class="login-logo-placeholder">🧪 TOXICOLOGIA</div>'
    ...
    highlights_html = "\n".join([
        ...
        '<strong>Análise de Positividade</strong>',
        '<p>Monitore taxas de positividade por laboratório, substância e região.</p>',
        '</div>',
        '</div>',
        '<div class="highlight-item">',
        ...
        '<p>Mapa interativo com distribuição epidemiológica por estado e cidade.</p>',
        '</div>',
        '</div>',
        '<div class="highlight-item">',
        '<div class="highlight-icon">📈</div>',
        '<div class="highlight-text">',
        '<strong>Tendências e Benchmarking</strong>',
        '<p>Compare laboratórios com médias nacionais e identifique padrões.</p>',
        '</div>',
        '</div>',
        '</div>',
    ])
